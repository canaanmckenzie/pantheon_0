...
## Task
Design IPC protocol specification - message framing for Named Pipes, start/stop/status/query commands, statistics serialization, configuration transmission
