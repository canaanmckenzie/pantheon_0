...
## Task
Design Windows service architecture - privilege escalation patterns, SYSTEM account service lifecycle, IPC boundary isolation, and integration with core VPN engine
