...
## Task
Analyze existing HinkyPunk C codebase structure - examine crypto layer, network abstraction, Linux TUN implementation, and identify integration points for Windows service
